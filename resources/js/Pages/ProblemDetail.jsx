  ...
  return (
        ...
        >
            ...
            <div className="">
                ...
                <tbody>
                    <tr>
                    <td class="text-center border border-slate-700 ...">Indiana</td>
                    <td class="text-center border border-slate-700 ...">Indianapolis</td>
                    </tr>
                </tbody>
                </table>
                ...
                <form class="flex space-x-2 border">
                    ...
                    <PrimaryButtonCustom className='w-1/6'>
                        Submit
                    </PrimaryButtonCustom>
                </form>
